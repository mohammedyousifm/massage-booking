@extends("layout.app")
@section('title', 'SplashWash - Premium Car Wash Booking')
...
@section('content')
    ...
    <section id="home" class="hero-gradient text-white relative overflow-hidden">
        <div class="absolute inset-0" id="bubble-container"></div>
        <div class="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0 car-slide-in">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6">مرحباً بكم في مساج الراحة </h1>
                    <p class="text-lg md:text-xl mb-8 text-blue-100">تعبان ... مرهق ... دلل نفسك لدينا
                        يعد مركز بوابة الإسترخاء المغربي من أرقى المراكز التي تقدم خدمات المساج و الحمامات الرياضية حيث
                        يتميز بفريق عمل مختص حاصل على مؤهلات علمية عالية وخبرات واسعة في هذه المجالات.</p>

                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                        <a href="#booking"
                            class="bg-white text-stone-950 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold text-center transition duration-300 shadow-lg">
                            احجز عبر الإنترنت الآن
                        </a>
                        <a href="#services"
                            class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 px-6 py-3 rounded-lg font-semibold text-center transition duration-300">
                            عرض الخدمات
                        </a>
                    </div>
                    ...
                    <div class="flex items-center">
                        <div class="flex -space-x-2 mr-4">
                            <div
                                class="w-10 h-10 rounded-full bg-blue-400 border-2 border-white flex items-center justify-center text-white text-xs">
                                JD</div>
                            <div
                                class="w-10 h-10 rounded-full bg-blue-500 border-2 border-white flex items-center justify-center text-white text-xs">
                                KM</div>
                            <div
                                class="w-10 h-10 rounded-full bg-blue-600 border-2 border-white flex items-center justify-center text-white text-xs">
                                RS</div>
                            <div
                                class="w-10 h-10 rounded-full bg-blue-700 border-2 border-white flex items-center justify-center text-white text-xs">
                                +</div>
                        </div>
                        <p class="text-blue-100  join">انضم إلى أكثر من 10000 عميل سعيد</p>
                    </div>
                </div>

                <div class="md:w-1/2 relative">
                    <div
                        class="bg-white p-6 rounded-xl shadow-2xl transform md:rotate-2 hover:rotate-0 transition duration-500">
                        {{-- <img src="{{ asset('images/images.jpeg') }}" alt="Luxury car being washed"
                            class="rounded-lg w-full mb-4"> --}}
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-gray-800 font-semibold">جلسات تدليك متميزة</h3>
                                <p class="text-gray-500">30-45 دقائق</p>
                            </div>
                            <div class="bg-blue-100 text-blue-600 px-3 py-1 rounded-full font-medium">
                                بوابة الإسترخاء
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="absolute -bottom-6 -left-6 bg-yellow-400 text-gray-800 rounded-lg p-3 shadow-lg transform -rotate-6 hover:rotate-0 transition duration-300">
                        <div class="font-bold">20% OFF</div>
                        <div class="text-sm">العملاء الجدد</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section  services" id="services">
        ...
        <div class="text-center">
            <div class="section-title animate-fade-up">
                <h2>الخدمات</h2>
                <p>نحن نقدم مجموعة متنوعة من خدمات المساج زات الجودة</p>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">المساج السويدي​</h3>
                    <p class="service-desc">المساج السويدي هو تقنية كلاسيكية تهدف إلى الاسترخاء وتخفيف التوتر، ويقدم العديد
                        من الفوائد، منها:
                    </p>
                ...
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">المساج العلاجي​</h3>
                    <p class="service-desc">المساج العلاجي يركز على علاج الآلام المزمنة والإصابات الجسدية، ويقدم العديد من
                        الفوائد، منها:</p>
                    <a href="#" class="btn-primary">المزيد</a>
                </div>
                ...
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">الحمام المغربي</h3>
                    <p class="service-desc">احصل على الحمام المغربي البلدي الاصلي في اجواء مغربية و على ايدي مغربية</p>
                    <a href="#" class="btn-primary">المزيد</a>
                </div>
            </div>
        </div>
    ...
    <!--(Order steps) Section -->
    <section id="order-steps-section" class="section-container">
        <div>
            <div class="section-title pt-5 animate-fade-up">
                <h2>خطوات الطلب</h2>
            ...
            <div class="p-6 md:p-8 space-y-8">
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">اختر نوع الخدمة</h3>
                        <p class="text-gray-600">اختر من بين مجموعة متنوعة من خدمات المساج المتميزة لدينا، مثل المساج
                            السويدي​ و المساج العلاجي​ و الحمام المغربي.</p>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">حدد موقعك</h3>
                        <p class="text-gray-600">أدخل موقعك الحالي أو المكان الذي تريد أن تتم فيه الخدمة. نصل إليك أينما
                            كنت!</p>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">اختر وقت مناسب</h3>
                        <p class="text-gray-600">حدد التاريخ والوقت المناسبين لك لتلقي الخدمة. نعمل على مدار الساعة
                            لنناسب
                            جدولك.</p>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">تأكيد الطلب والدفع</h3>
                        <p class="text-gray-600">راجع تفاصيل طلبك واختر طريقة الدفع المناسبة. نقبل جميع طرق الدفع
                            الإلكترونية والنقدية.</p>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">استلم الخدمة</h3>
                        <p class="text-gray-600">استرخِ واترك الباقي علينا! سنصل إليك في الوقت المحدد لنقدم لك خدمة المساج
                            لا مثيل لها.</p>
                    </div>
                </div>
                ...
                <div class="mt-8 text-center">
                    <a href="#booking"
                        class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition transform hover:-translate-y-1 hover:shadow-lg">
                        اطلب الآن
                    </a>
                </div>
            </div>
            ...
            <div class="faq-container">
                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>كيف يمكنني حجز جلسة مساج؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>يمكنك حجز جلسة مساج بسهولة عبر تطبيقنا المتوفر على متجر آبل وجوجل بلاي، أو من خلال موقعنا
                            الإلكتروني. اختر نوع المساج، وحدد الوقت والمكان المناسبين، وسيصل معالجنا المختص إليك أينما كنت.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>ما أنواع المساج التي تقدمونها؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نقدم مجموعة متنوعة من جلسات المساج، بما في ذلك المساج السويدي، العلاجي، مساج الأنسجة العميقة،
                            ومساج الاسترخاء. يمكنك اختيار النوع الأنسب لاحتياجاتك أثناء الحجز.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل المعالجون معتمدون وذوو خبرة؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نعم، جميع معالجينا حاصلون على شهادات معتمدة في العلاج بالتدليك، ولديهم خبرة واسعة لضمان حصولك على
                            تجربة مريحة وآمنة.</p>
                    </div>
                </div>
                ...
                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل يمكنني إلغاء أو تغيير موعد الجلسة؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نعم، يمكنك إلغاء أو تعديل موعد الجلسة مجاناً حتى ساعتين قبل الموعد المحدد. بعد ذلك قد تُطبق رسوم
                            إضافية. يمكنك إدارة مواعيدك بسهولة عبر التطبيق أو عبر الاتصال بفريق الدعم لدينا.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل تقدمون خدمات المساج في جميع المدن؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>حالياً، نقدم خدماتنا في المدن الرئيسية مثل الرياض، جدة، الدمام والخبر. ونعمل على توسيع نطاق
                            تغطيتنا لتشمل المزيد من المدن قريباً. يمكنك التحقق من المناطق المغطاة عبر تطبيقنا أو موقعنا.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="booking" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-gray-50 rounded-2xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/3 bg-blue-600 text-white p-8">
                        <h3 class="text-2xl font-bold mb-4">الحجز السريع</h3>
                        <p class="mb-6">حدد الخدمة والتاريخ والوقت للبدء.</p>
                        <div class="space-y-4 text-sm">
                            <div class="flex items-center">
                                <i class="fas fa-clock w-6"></i>
                                <span>مفتوح من الساعة 7 صباحًا حتى 9 مساءً</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-calendar-alt w-6"></i>
                                <span>7 أيام في الأسبوع</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-map-marker-alt w-6"></i>
                                <span>مواقع متعددة</span>
                            </div>
                        </div>
                    </div>
                    <div class="md:w-2/3 p-8">
                        <form method="Post" action="{{ route('booking') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div class="mb-6">
                                    <label for="phone" class="block text-gray-700 mb-2">رقم الهاتف / واتساب</label>
                                ...
                                <div class="mb-6">
                                    <label class="block text-gray-700 mb-2">حدد التاريخ</label>
                                    <input type="date" name="date"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>

                                <div class="mb-6">
                                    <label for="time" class="block text-gray-700 mb-2">حدد الوقت</label>
                                    <input type="time" name="time" id="time" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>

                                <div class="mb-6 w-100">
                                    <label class="block text-gray-700 mb-2">اختر الخدمة</label>
                                    <select name="service_type"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="المساج السويدي">المساج السويدي</option>
                                        <option value="الحمام المغربي">الحمام المغربي</option>
                                        <option value="المساج العلاجي">المساج العلاجي</option>
                                    </select>
                                </div> <br>

                                <div class="mb-6 w-100">
                                    <label for="address" class="block text-gray-700 mb-2">العنوان بالتفصيل</label>
                                    <textarea name="address" id="address" required rows="3"
                                        ...
                                        placeholder="اكتب عنوانك بالتفصيل هنا"></textarea>
                                </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
                <div class="flex items-center lg:mb-0 mb-10">
                    <div class="">
                        <h4 class="text-indigo-600 text-base font-medium leading-6 mb-4  text-center">
                            تواصل معنا</h4>
                        <h2 class="text-gray-900 font-manrope text-4xl font-semibold leading-10 mb-9  text-center">
                            معلومات شخصية</h2>
                        <form method="post" action="{{ route('email') }}">
                            ...
                            <button type="submit"
                                class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-indigo-600 shadow transition-all duration-700 hover:bg-indigo-800">إرسال</button>
                        </form>
                    </div>
                </div>
                <div
                    ...
                    <div class="">
                        <div class="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                            ...
                            <a href="javascript:;" class="flex items-center mb-6">
                                ...
                                <h5 class="text-black text-base font-normal leading-6 ml-5">789 Oak Lane, Lakeside, TX
                                    54321</h5>
                            </a>
                            <div class="flex items-center justify-center border-t border-gray-100 pt-6">
                                ...
                                <a href="javascript:;" class="mr-6">
                                    <svg width="31" height="30" viewBox="0 0 31 30" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.0683594" width="30" height="30" rx="15"
                                            fill="url(#paint0_linear_11773_24443)"></rect>
                                        <path
                                            ...
                                            fill="white"></path>
                                        <defs>
                                            <linearGradient id="paint0_linear_11773_24443" x1="29.4918" y1="30"
                                                x2="-0.50824" y2="-8.07516e-07" gradientUnits="userSpaceOnUse">
